...
export const api = {
  get: (e: string, t?: string) => fetchApi(e, { token: t }),
  post: (e: string, b: any, t?: string) => fetchApi(e, { method: 'POST', body: JSON.stringify(b), token: t }),
  patch: (e: string, b: any, t?: string) => fetchApi(e, { method: 'PATCH', body: JSON.stringify(b), token: t }),
};
