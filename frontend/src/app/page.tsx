...
import { Coins, ArrowRight, Wallet, BadgeCheck, Users, Shield, Zap, Gift } from 'lucide-react';
    ...
    <div className="min-h-screen">
      ...
      <section id="features" className="py-20 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            {icon:Zap,t:'Instant Crypto Payouts',d:'Paid in BTC, ETH, LTC, DOGE, USDT.'},
            {icon:Shield,t:'Secure Platform',d:'2FA, encryption, automated verification.'},
            {icon:Users,t:'Referral Bonuses',d:'Earn up to 20% commission on referrals.'},
            {icon:Wallet,t:'5 Cryptocurrencies',d:'Bitcoin, Ethereum, Litecoin, Dogecoin, USDT.'},
            {icon:Gift,t:'Daily Bonuses',d:'Login streaks and achievement rewards.'},
            {icon:BadgeCheck,t:'Membership Tiers',d:'Free to Diamond. Up to 30% earnings boost.'}
          ].map(({icon:I,t,d}, i) => (
            <div key={i} className="card card-hover">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center mb-4"><I size={22}/></div>
      ...
      <footer className="border-t border-[#27272a] py-8 px-4 text-center text-sm text-zinc-600">© 2026 RewardHub</footer>
    </div>
  );
}